...
app.post('/test_post', (request, response) => {
	console.log('有人请求test_post了', request.query)
	//使用中间件解析urlencoded编码形式的请求体参数
	// 使用post发送请求体参数时，需要配置。是否有请求体可以看Network中文件的最后是否有Form Data
	// app.use(express.urlencoded({ extended: true }))
...
// 获取params参数
// app.get('/test_jquery_get:school', (request, response) => {
// 	console.log('有人请求test_jquery_get了', request.params);
// 	const car = { name: '马自达·阿特兹', price: '25万' }
// 	response.send(JSON.stringify(car))
// })
